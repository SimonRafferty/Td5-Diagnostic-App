...
```bash
arduino-cli compile --fqbn esp32:esp32:XIAO_ESP32S3 Td5_ESPNow_Diagnostic/Td5_Diagnostic
arduino-cli upload  --fqbn esp32:esp32:XIAO_ESP32S3 -p <PORT> Td5_ESPNow_Diagnostic/Td5_Diagnostic
```
